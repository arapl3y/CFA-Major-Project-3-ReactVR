    ...
    return (
        ...
        <a-assets>
          ...
          {this.state.imageIds.map((image, i) =>
            <img id={`test${i}`} src={`http://localhost:3000/images/${image._id}`} />
          )}
        ...
        <Entity primitive="a-box" position="3 1.5 -2" width="2.5" height="2" depth="0.1" src="#test0" />
        <Entity primitive="a-box" position="3 1.5 -1" width="2.5" height="2" depth="0.1" src="#test1" />
        <Entity primitive="a-box" position="3 1.5 0" width="2.5" height="2" depth="0.1" src="#test2" />
        <Entity primitive="a-box" position="3 1.5 1" width="2.5" height="2" depth="0.1" src="#test3" />
        <Entity primitive="a-box" position="3 1.5 2" width="2.5" height="2" depth="0.1" src="#test4" />
